    ...
    <div className="w-[1284px] h-[1024px] border-2 px-[36px] py-[24px] gap-[32px] flex flex-col bg-[#E5E7EB]">
      ...
      <div className="w-[1212px]">
        <div className="w-[1212px] h-[22px] flex justify-between items-center">
          <p className="font-bold text-[16px] text-[#83858B] leading-[21.82px]">
            COURSE LIST
          </p>
          <div className="flex items-center gap-[5px] w-[223px] h-32px bg-[#ffffff] p-[8px] rounded-[4px] border border-[#E5E7EB]">
            ...
            <input
              type="search"
              placeholder="Search"
              className="outline-0 font-normal text-[12px] leading-[16.37px] text-[#83858B]"
              value={searchTerm}
                  ...
                  <tr className="border-b border-[#E5E7EB] font-normal text-[14px] text-[#212529] leading-[19px]">
                    ...
                    <td className="text-center">
                      <p
                        className={
                          ele.status === "Active"
                            ? " bg-[#CFF9DF] rounded-[4px] px-[5px] py-[4px] text-[12px]"
                            : ele.status === "Closed"
                            ? "px-[5px] py-[4px] bg-[#FEC0CA] rounded-[4px]"
                            : "px-[5px] py-[4px] bg-[#E5E7EB] rounded-[4px]"
                        }
                      >
                        {ele.status}
                      </p>
        ...
        <button
          ...
          className="flex gap-[12px] px-[20px] py-[16px] top-[919px] left-[1155px] absolute bg-[#FEC0CA] rounded-[8px]"
          type="button"
                ...
                <div className="border-0 rounded-[8px] relative flex flex-col gap-[16px] w-full bg-white outline-none focus:outline-none p-[16px]">
                  ...
                  <div className="relative flex flex-col gap-[8px]">
                    <input
                      ...
                      className="w-[463px] h-[32px] px-[8px] rounded-[4px] border border-[#E5E7EB] outline-none focus:outline-none"
                    />
                    <input
                      type="text"
