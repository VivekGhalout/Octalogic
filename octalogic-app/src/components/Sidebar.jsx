    ...
    return (
        <div className='w-24 h-[64rem] border-r border-gray-300 py-2.5 px-3 flex flex-col gap-[48px] justify-center items-center'>
            ...
            <div className='w-[72px] h-[116px] flex flex-col gap-[16px] justify-center items-center'>
                <div className='w-[72px] h-[50px] py-[5px] flex flex-col justify-center items-center bg-[#FEDFE1] rounded-[6px]'>
                ...
                <div className='w-[72px] h-[50px] py-[5px] flex flex-col justify-center items-center bg-[#E5E7EB] rounded-[6px]'>
